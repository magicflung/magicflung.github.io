  ...
  return function (e) {
    ...
    !function (i) {
      ...
      function d(e, n) {
        ...
        var t, r, i, o, l, d = 1732584193, p = -271733879, f = -1732584194, m = 271733878;
    ...
    function a(e) {
      function n(e) {
        var n = o[e.replace(/\*/g, "_")[1] || ""], t = p[p.length - 1] == e;
    ...
    t(2);
    var l = t(0), s = location.pathname, c = {
      ip: "",
      comment: "",
      rid: "",
      at: "",
      ...
      pin: 0,
      like: 0
    }, u = {}.toString, v = localStorage, d = function () {
      function e(n) {
        r(this, e);
        var t = this;
      ...
      return i(e, [{
        key: "init", value: function (e) {
          ...
          try {
            ...
            }, n.nodata.show(), t.init({appId: e.app_id || e.appId, appKey: e.app_key || e.appKey}), n.v = t
          } catch (e) {
          ...
          d.select(["nick", "comment", "link", "rid", "isSpam", "emailHash", "like", "pin"]), d.equalTo("url", s), d.descending("createdAt"), d.limit("1000"), d.find().then(function (e) {
            var t = e.length;
            if (n.el.querySelector(".count").innerHTML = "" + t, t) for (var r = t - 1; r > -1; r--) {
              var i = e[r];
              if (!i.get("isSpam")) {
                ...
                var l = n.el.querySelector(".vlist"), s = l.querySelectorAll("li"), c = a.querySelector(".vat"),
        ...
        key: "bind", value: function () {
          var e = this, n = {veditor: "comment", vnick: "nick", vlink: "link", vmail: "mail"}, t = {};
          for (var r in n) n.hasOwnProperty(r) && function () {
            var i = n[r], a = e.el.querySelector("." + r);
          ...
          i(), e.reset = function () {
            for (var t in n) if (n.hasOwnProperty(t)) {
              var r = n[t], a = e.el.querySelector("." + t);
              a.value = "", c[r] = ""
            }
            c.rid = "", c.nick = "小可爱", i()
          };
          var a = e.el.querySelector(".vsubmit"), s = function (n) {
            ...
            if ("" == c.nick && (c.nick = "小调皮"), c.comment = (0, o.default)(c.comment), c.comment.indexOf(c.at) > -1 && "" != c.at) {
              var r = '<a class="at" href=\'#' + c.rid + "'>" + c.at + "</a>";
              c.comment = c.comment.replace(c.at, r)
            }
            var i = f.mail(c.mail), l = f.link(c.link);
            i.k || 0 === c.link.length || l.k ? i.k ? 0 === c.link.length || l.k ? (c.mail = i.v, c.link = l.v, d()) : (c.link = "", c.mail = i.v, e.alert.show({
              ...
              type: 1, text: "您的邮箱格式不正确, 是否继续提交?", cb: function () {
                d()
              }
            })) : (c.mail = "", c.link = "", e.alert.show({
              type: 1, text: "您的网址和邮箱格式不正确, 是否继续提交?", cb: function () {
                d()
              }
            }))
          }, u = function () {
            ...
            var n = e.v.Object.extend("Comment"), t = new n;
            ...
            t.set("emailHash", l(c.mail.toLowerCase().trim())), t.setACL(u()), t.save().then(function (n) {
              v && v.setItem("ValineCache", JSON.stringify({nick: c.nick, link: c.link, mail: c.mail}));
              ...
              var o = e.el.querySelector(".vlist"), l = o.querySelectorAll("li"), s = r.querySelectorAll("a");
          ...
          e.bindAt = function (e) {
            p.on("click", e, function (n) {
              var r = e.getAttribute("at"), i = e.getAttribute("rid");
      ...
      var n = g(e.getDate(), 2), t = g(e.getMonth() + 1, 2);
    ...
    function i(e, n) {
      for (var t = [], r = {}, i = 0; i < e.length; i++) {
        var a = e[i], o = n.base ? a[0] + n.base : a[0], l = a[1], s = a[2], c = a[3],
          u = {css: l, media: s, sourceMap: c};
        r[o] ? r[o].parts.push(u) : t.push(r[o] = {id: o, parts: [u]})
      }
      return t
    }
    ...
    function a(e, n) {
      ...
      var r = w[w.length - 1];
      if ("top" === e.insertAt) r ? r.nextSibling ? t.insertBefore(n, r.nextSibling) : t.appendChild(n) : t.insertBefore(n, t.firstChild), w.push(n); else {
    ...
    function v(e, n, t, r) {
      var i = t ? "" : r.css;
      if (e.styleSheet) e.styleSheet.cssText = x(n, i); else {
    ...
    function p(e, n, t) {
      var r = t.css, i = t.sourceMap, a = void 0 === n.convertToAbsoluteUrls && i;
